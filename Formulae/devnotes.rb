class Devnotes < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Hpareek07/devnotes/releases/download/v1.0.0/devnotes-v1.0.0-darwin-arm64.tar.gz"
      sha256 "21b984ee934afb8271b8547724cd913350c2cd34903110e92f7e59f56dba737f"
    else
      url "https://github.com/Hpareek07/devnotes/releases/download/v1.0.0/devnotes-v1.0.0-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/Hpareek07/devnotes/releases/download/v1.0.0/devnotes-v1.0.0-linux-arm64.tar.gz"
      sha256 "7093f6643322a8c00a740e968163f5b3fcf03e212bc97fc9af38a94038d690d9"
    else
      url "https://github.com/Hpareek07/devnotes/releases/download/v1.0.0/devnotes-v1.0.0-linux-amd64.tar.gz"
